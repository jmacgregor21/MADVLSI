...
N 240 -150 240 -140 { lab=#net3}
N 340 -150 340 -140 { lab=#net4}
N 410 -110 540 -110 { lab=clk}
N 510 -170 510 -110 { lab=clk}
N 60 -220 80 -220 { lab=Db}
N 60 -260 80 -260 { lab=D}
N 140 -260 480 -260 { lab=#net5}
N 140 -220 480 -220 { lab=#net6}
N 240 -270 240 -260 { lab=#net5}
N 240 -260 240 -210 { lab=#net5}
N 270 -220 270 -180 { lab=#net6}
N 270 -300 270 -220 { lab=#net6}
N 310 -300 310 -260 { lab=#net5}
N 310 -260 310 -180 { lab=#net5}
N 340 -220 340 -210 { lab=#net6}
N 340 -270 340 -220 { lab=#net6}
...
C {devices/iopin.sym} 770 -430 3 0 {name=p1 lab=VP}
C {devices/ipin.sym} 540 -110 2 0 {name=p2 lab=clk}
C {devices/ipin.sym} 60 -260 0 0 {name=p4 lab=D}
C {devices/ipin.sym} 60 -220 0 0 {name=p5 lab=Db}
C {devices/opin.sym} 880 -260 0 0 {name=p6 lab=Q}
C {devices/opin.sym} 880 -220 0 0 {name=p7 lab=Qb}
C {devices/iopin.sym} 650 -430 3 0 {name=p8 lab=VP}
C {devices/iopin.sym} 770 -110 1 0 {name=p9 lab=VN}
C {devices/iopin.sym} 650 -110 1 0 {name=p10 lab=VN}
...
C {devices/iopin.sym} 240 -80 1 0 {name=p3 lab=VN}
C {devices/iopin.sym} 340 -80 1 0 {name=p11 lab=VN}
C {devices/iopin.sym} 240 -330 3 0 {name=p12 lab=VP}
C {devices/iopin.sym} 340 -330 3 0 {name=p13 lab=VP}
