...
N 480 -570 480 -550 { lab=V1}
N 400 -570 400 -550 { lab=Vbp}
...
C {devices/code_shown.sym} 320 -410 0 0 {name=s1 only_toplevel=false value="
.control
tran 0.01n 500n 
run
plot v(Vout) v(V1)
...
C {madvlsi/vsource.sym} 480 -520 0 0 {name=V1
value="pwl(0 0.5 25n 0.5 26n 0.501 30n 0.501 31n 0.5 221n 0.5 222n 0.499 226n 0.499 227n 0.5)"}
C {devices/gnd.sym} 480 -490 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} 480 -570 2 0 {name=l19 sig_type=std_logic lab=V1}
C {madvlsi/isource.sym} 400 -520 0 0 {name=I1
value=1.5u}
C {devices/lab_pin.sym} 400 -570 2 0 {name=l22 sig_type=std_logic lab=Vbp}
C {devices/gnd.sym} 400 -490 0 0 {name=l23 lab=GND}
