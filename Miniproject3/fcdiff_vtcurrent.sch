...
.control
dc V1 0.35 0.65 0.001
run
plot v(Vout) v(V2) v(V1) i(Vout)
.endc"}
...
C {madvlsi/vsource.sym} 710 -500 0 0 {name=Vout
value=0.75}
C {devices/gnd.sym} 710 -470 0 0 {name=l25 lab=GND}
C {devices/lab_pin.sym} 710 -530 2 0 {name=l26 sig_type=std_logic lab=Vout}
